...
class CustomAttention(nn.Module):
    ...
    def forward(self, input):
        ...
        return output, M, (first_conv, second_conv, third_conv)


class MultiStageBasicVSRAnalysis(basicVSR):
    ...
    def forward(self, input):
        ...
        attention_output, M, (first_conv, second_conv, third_conv) = self.attention((output_1, output_2, output_3))
        ...
        return out, attention_output, M, (first_conv, second_conv, third_conv), res, (output_1, output_2, output_3), base
